# export-signatures-v2.ps1
# Simple version — just greps for def/class/function lines
#
# Usage: Place this file in your Hello project root, then run:
#   powershell -ExecutionPolicy Bypass -File export-signatures-v2.ps1
