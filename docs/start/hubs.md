---
summary: "Complete map of docs pages grouped by domain."
read_when:
  - You want full docs coverage, not just quick links
  - You are deciding where to add new documentation
title: "Docs Hubs"
---
...
- OpenAPI export artifact: `docs/api/openapi.json`
