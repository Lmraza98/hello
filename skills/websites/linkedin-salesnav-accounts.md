...
- 2026-03-06T15:08:09.603706+00:00 | issue=STOP_VALIDATION_FAILED | count=0, reasons=count_out_of_range,required_fields_missing,low_unique_url_fraction, task=salesnav_list_employees
- 2026-03-06T15:56:24.089013+00:00 | issue=STOP_VALIDATION_FAILED | count=0, reasons=count_out_of_range,required_fields_missing,low_unique_url_fraction, task=salesnav_list_employees
- 2026-03-06T17:05:32.852713+00:00 | issue=STOP_VALIDATION_FAILED | count=0, reasons=count_out_of_range,required_fields_missing,low_unique_url_fraction, task=salesnav_search_account
- 2026-03-06T17:06:33.046649+00:00 | issue=entrypoint_failed_all_hints | attempted_hints=[{'role': 'link', 'text': 'all employees'}, {'role': 'link', 'text': 'decision makers'}, {'role': 'button', 'text': 'view current employees'}, {'role': 'link', 'text': 'view all employees'}], last_error=502: {'code': 'act_failed', 'message': 'Locator.click: Timeout 15000ms exceeded.\nCall log:\n  - waiting for locator("a,button,input,textarea,select,[role=\'button\'],[role=\'link\'
- 2026-03-06T18:41:03.078555+00:00 | issue=STOP_VALIDATION_FAILED | count=0, reasons=count_out_of_range,required_fields_missing,low_unique_url_fraction, task=salesnav_search_account
- 2026-03-06T18:41:59.576952+00:00 | issue=pagination_next_failed_all_hints | attempted_hints=[{'role': 'button', 'text': 'next'}, {'role': 'link', 'text': 'next'}], last_error=502: {'code': 'act_failed', 'message': 'Locator.click: Timeout 15000ms exceeded.\nCall log:\n  - waiting for locator("a,button,input,textarea,select,[role=\'button\'],[role=\'link\'],[role=\'textbox\'],[role=\'searchbox\'],[role=\'combobox\'],[contenteditable=\'true\'],[tabindex]").nth(20)\n  -     -
- 2026-03-06T18:52:57.740611+00:00 | issue=STOP_VALIDATION_FAILED | count=0, reasons=count_out_of_range,required_fields_missing,low_unique_url_fraction, task=salesnav_search_account
