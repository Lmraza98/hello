import { canonicalChildId } from "./ids.js";

export function pickPreferredAggregateId(runRow, graphNodes) {
...
export function pickActiveRunNodeId(runRow, graphNodes, statusMap) {
  const nodes = Array.isArray(graphNodes) ? graphNodes : [];
...
export function pickActiveAggregateFromGraph(graphNodes, statusMap) {
...
export function pickAggregateForActiveChild(activeChildId, graphNodes, fallbackAggregateId = "") {
...
export function pickActiveChildFromAggregateNode(aggregateNode) {
