export function canonicalChildId(parentId, rawChildId) {
...
export function normalizeChildSelectionId(parentId, childId) {
  const parent = String(parentId || "").trim();
...
export function normalizeSuiteSelectionNodeId(nodeId, nodesList) {
...
export function isPytestGateAggregateId(aggregateId, nodes = []) {
...
export function createIdsForRun({
  ...
  return function idsForRun(scope = "all") {
