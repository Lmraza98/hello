...
export function useAppOrchestrationRoot() {
  ...
  const { chrome, topBar, testsView, graphView } = useAppShellViewModel({
    ...
    layout: {
      main: layout,
      mainDividerPx: DIVIDER_PX,
      startDrag,
      overlayDetailsMinPx: OVERLAY_DETAILS_MIN_PX,
      tests: {
        ref: testsLayoutRef,
        detailsInline,
        suitesMinPx,
      ...
      graph: {
        ...
        centerMinPx: GRAPH_CENTER_MIN_PX,
        dividerPx: GRAPH_DIVIDER_PX,
        rightMinPx: GRAPH_RIGHT_MIN_PX,
